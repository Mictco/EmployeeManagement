...
namespace EmployeeManager.Server.DataAccess
{
    public class EmployeeDataAccessLayer : IEmployee
    {
        ...
        {
            string filepath = @"D:\Opensource\Blazor-CRUD-With-CloudFirestore-master\BlazorWithFirestore\BlazorWithFirestore\FirestoreAPIKey\mictcoexeupdate-b9a6216b8eab.json";
            Environment.SetEnvironmentVariable("GOOGLE_APPLICATION_CREDENTIALS", filepath);
            projectId = "mictcoexeupdate";
